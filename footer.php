        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <form action="" method="post">
              <input type="email" name="email"><input type="submit" class="h-100" value="Subscribe">
            </form>
          </div>
    ...
    <div class="container">
      ...
      <div class="copyright-wrap d-md-flex py-4">
        ...
        <div class="social-links text-center text-md-right pt-3 pt-md-0">
          <a href="https://twitter.com/CynthiaENgozi1" class="twitter"><i class="bx bxl-twitter"></i></a>
          <a href="" class="facebook"><i class="bx bxl-facebook"></i></a>
          <a href="https://github.com/cindyeme" class="github"><i class="bx bxl-github"></i></a>
          <a href="https://medium.com/@emereninicynthia" class="google-plus"><i class="bx bxl-medium"></i></a>
          <a href="https://www.linkedin.com/in/emerenini-cynthia-ngozi" class="linkedin"><i class="bx bxl-linkedin"></i></a>
        </div>
      </div>
